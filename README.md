...
- `desk/quote.py` — `--county`, `--hera`, `--rural`, `--mix`, `--batch`, `--hera-areas`, `--floor-il`, `--ua-method`, `--ua-ladder`, `--s8-hap`
- `data/ua_methods.csv` — 10-rung 26 CFR 1.42-10 applicable-UA table
- `examples/` — Autauga 2BR 60%; Barbour rural lift; Presidio HERA vs Regular; hold-harmless; UA ladder
- `data/SOURCES.md` — HUD USER xlsx URLs + IRC / 1.42-10 cites
...
SKU: NSF-20260827-LIHTC-MTSP | Decision: list | Cycle: 2026-08-28 polish
